...
const itemPrices = {
    jacket: [150, 160, 170, 180, 150, 160, 170, 180, 150], // Prices for jacket options
    shirt: [50, 55, 60, 50, 55, 60, 50, 55], // Prices for shirt options
    tie: [20, 25, 30, 20, 25, 30, 80], // Prices for tie options
...
function changeImage(type, direction) {
    ...
    if (type === 0) { // Jacket
        ...
        document.getElementById("shirtImage").src = `images/shirts/s${currentShirt}.png`;
        ...
        document.getElementById("tieImage").src = `images/ties/t${currentTie}.png`;
        ...
        document.getElementById("shoesImage").src = `images/shoes/f${currentShoes}.png`;
